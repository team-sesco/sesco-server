...
from model.metaf import PoolFormer_test
import os
from utills.endecoder import crop_indexing, crop_aware_name_decoder, crop_aware_decoder_kr

class Inference:
    meta_arg = {
        'name':'poolformer_m36',
        'model_name':PoolFormer_test,
        'path':"./weights/poolformer_nonpad.pth",
        'img_size':224,
        }
    """
    0:아무것도없음
